...
public class Araba {
    ...
    DEFAULT CONSTRUCTOR denir ve bu contructor gorunmez

    eger biz gorunur bir constructor imiz olsun istersek
    default constructor ile ayni gorevi yapa bir constructor olusturabiliriz
    ...
    /*bir kod blogunuun method veya constructor olmasindan emin olmak istiyorsaniz
    ...
    ozetle : constructorun adi class adi ile ayni olmali
    return type i olmamali

     */

    public Araba(String renk){
        System.out.println(renk+" renkli bir ara uretildi");
